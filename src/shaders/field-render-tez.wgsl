// TEz field renderer. Signed Hz (red/blue, dual of Ez in TMz) or |E|
// envelope (heat ramp). Material tint, source rings, probe rings share the
// same palette as field-render.wgsl.
...
@group(0) @binding(1) var<storage, read> hzx: array<f32>;
@group(0) @binding(2) var<storage, read> hzy: array<f32>;
